...
[_QWERTY] = LAYOUT( \
  ...
  _______, _______, _______, KC_LALT, LEFTY, KC_ENT, KC_SPC, RIGHTY, KC_RALT, _______, _______,  _______ \
),
...
[_LEFTY] = LAYOUT( \
  ...
  KC_DEL,  KC_CAPS, KC_LGUI, KC_PSCREEN, KC_F13, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_LBRC, KC_RBRC, \
...
[_RIGHTY] = LAYOUT( \
  ...
  KC_F1,  KC_F2, KC_F3,  KC_F4,  KC_F5,   KC_F6, KC_EQL,  KC_MINS, KC_BSLS, KC_SLSH, _______, _______, \
  KC_F7, KC_F8, KC_F9,  KC_F10,  KC_F11,   KC_F12, KC_UNDS, KC_HOME, KC_PGDN, KC_PGUP, KC_END, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
),
